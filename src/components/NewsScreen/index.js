...
import './index.css'
import NewsScreenCards from "./NewsScreenCards";

function NewsScreen() {
    return (
        <section className="news-screen">
            <div className="row">
                <div className="col-12 news-screen__wrapper">
                    <div className="news-screen__top">
                        <div className="news-screen__heading">
                            <div className="news-screen__heading-title">
                                <h2>Новости</h2>
                            </div>
                            <div className="news-screen__heading-subtext">
                                самое актуальное на сегодняшний день в мире bim-проектирования
                            </div>
                        </div>
                        <div className="news-screen__subscribe">
                            <label for="mail">
                                подпишитесь на наши новости
                            </label>
                            <div className="news-screen__subscribe-input">
                                <input id="mail" type="email" placeholder="your@email.ru" />
                                <button>
                            ...
                            <div className="news-screen__subscribe-subtext">
                                Отправляя заполненную форму, вы принимаете условия <a>Политики обработки персональных данных</a> и подписываете <a>Заявление-согласие субъекта</a> на передачу его персональных данных третьей стороне.
                            </div>
                        </div>
                    </div>
                    <NewsScreenCards />
